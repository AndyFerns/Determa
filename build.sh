...
# 3. Test Source
TEST_SOURCES="tests/test_runner.c tests/test.c tests/lexer/test_lexer.c tests/parser/test_parser.c tests/typechecker/test_typechecker.c tests/vm/test_vm.c tests/vm/test_gc.c $LIB_SOURCES"
